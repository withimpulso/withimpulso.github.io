...
const messages: Record<Language, Messages> = {
  en: {
    ...
    "home.description": "Impulso helps organizations navigate Modern Workplace, Identity, and Security. We deliver expert guidance that turns complexity into momentum.",
    ...
    "services.training.description": "Upskill your team with hands-on, expert-led trainings. From Microsoft 365 fundamentals to advanced security operations, we provide practical knowledge that sticks.",
    ...
    "why.boutique.description": "You work directly with senior consultants. No juniors are learning on your dime.",
    ...
    "trainings.description": "Practical, hands-on trainings delivered by senior consultants who work with these technologies every day. No slides-only sessions. Real skills and real scenarios.",
